...
```
* visualize the component of the most popular crime types in each boro
```{r}
library(gridExtra)
place_boro = crime_type %>%
  ...
  top_place = place_boro$prem_typ
   ...
   place_boro_plot = crime_type %>%
    ...
    labs(title = "Five Top Places Where Crimes Usually Happen",
    x = "Place",
    y = "Frequency")

 
grid.arrange(place_boro_plot,boro_plot[[1]],boro_plot[[2]],boro_plot[[3]],boro_plot[[4]],boro_plot[[5]],ncol=2,top = "Commen Types of Crime in Each Boro")
```
