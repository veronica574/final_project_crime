...
crime_number %>%
  ggplot(aes(x = boro, y = n, fill = boro)) + geom_bar(stat = "identity", alpha = 0.8, width = 0.8) +
  labs(title = "Number of Crimes in each borough",
       x = "Borough",
       y = "Number of crimes") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1), legend.position = "none")
```

The main propose of this part is to analyze: 1. the difference of crime cases among five boroughs (Manhattan, Bronx, Brooklyn, Queens and Staten Island) in New York City. From the result, we can clearly conclude that due to its smaller size, staten island has the lowest number of crimes. The borough with the largest number of crime cases is Brooklyn, followed by Manhattan, Bronx and Queens. The number of crime cases in these four boroughs are slightly different from each other.
